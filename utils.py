...
def detect_horizon_line(image_grayscaled):
    ...
    image_blurred = cv2.GaussianBlur(image_grayscaled, ksize=(5, 5), sigmaX=0)
    ...
    cv2.imshow('frame1',image_blurred)
    # cv2.imshow('frame2',image_thresholded)
    # cv2.imshow('frame3',image_closed)
